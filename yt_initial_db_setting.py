...
genre_saved_mfcc = os.path.join(os.getcwd(), 'WebApp', 'static', 'mfccs', 'yt_mfcc.json')
...
genre_model_path = os.path.join(os.getcwd(), 'WebApp', 'python_scripts', 'genre_pred', 'saved_model')
...
with app.app_context():
    ...
    full_mix_dir = os.path.join(os.getcwd(), 'audio_data', 'yt_split')
